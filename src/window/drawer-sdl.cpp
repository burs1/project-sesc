...
auto DrawerSDL::SetDrawFont(const char* font) -> void {
  draw_font_ = font;
}
...
// Internal methods
// ~ Render
auto DrawerSDL::RenderTextSDL(const char* text, const char* font, SDL_Rect* rect) -> SDL_Texture* {
